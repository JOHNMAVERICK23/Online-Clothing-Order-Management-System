...
<body>
    ...
    <section class="home-hero">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="<?php echo getCmsContent('hero', 'button1_link', 'shop.php'); ?>" class="btn-hero">
    ...
    <section class="featured-section">
                        ...
                        <div class="product-card">
                            ...
                            <div class="product-content">
                                ...
                                <div class="product-actions">
                                    <a href="shop.php?search=<?php echo urlencode($product['product_name']); ?>" class="btn-product">
                                        View Details
                                    </a>
        ...
        <div class="view-all">
            <a href="shop.php" class="btn-hero btn-hero-outline" style="background: var(--dark); color: var(--light);">
            ...
            <div class="category-card">
                ...
                <div class="category-overlay">
                    <div class="category-content">
                        ...
                        <a href="shop.php?category=<?php echo urlencode($category); ?>" class="category-cta">
