...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['cancel_order'])) {
    ...
    $check_stmt = $pdo->prepare("SELECT status FROM orders WHERE id = ? AND user_id = ?");
                        ...
                        <div class="order-summary">
                            <div class="summary-grid">
                                ...
                                <div class="summary-item">
                                    ...
                                    <div class="summary-value">₱<?php echo number_format($order['order_total'], 2); ?></div>
                                </div>
                                <div class="summary-item">
    ...
    <script>
        ...
        async function viewOrderDetails(orderId) {
            try {
                ...
                if (typeof window.utils !== 'undefined' && window.utils.showNotification) {
                    window.utils.showNotification('Unable to load order details. Please try again.', 'error');
                } else {
        ...
        function reorderItems(orderId) {
            if (confirm('Would you like to add all items from this order to your cart?')) {
                ...
                setTimeout(() => {
                    if (typeof window.utils !== 'undefined' && window.utils.showNotification) {
                        window.utils.showNotification('All items have been added to your cart!', 'success');
                    } else {
                    ...
                    if (typeof window.cart !== 'undefined') {
                        ...
                        window.cart.updateCount(currentCount);
                    }
                }, 1000);
            }
        }
